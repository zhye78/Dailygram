...
public class Heart {
    ...
    public ImageView hearWhite, heartRed;

    public Heart(ImageView hearWhite, ImageView heartRed) {
        this.hearWhite = hearWhite;
    ...
    public void toggleLike(){
        ...
        if(heartRed.getVisibility()== View.VISIBLE){
            Log.d(TAG, "toggleLike: toggling red geart off.");
            ...
            hearWhite.setVisibility(View.GONE);
